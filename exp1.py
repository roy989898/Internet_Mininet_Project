...
class CreateTopo(Topo):
    ...
    def __init__(self, n=1, cpu=.1, bw=10, delay=None,
        ...
        lconfig_h2_s1 = {'bw': bw, 'delay': 1 + 'ms', 'max_queue_size': max_queue_size, 'loss': 0}
        lconfig_h3_s2 = {'bw': bw, 'delay': 1 + 'ms', 'max_queue_size': max_queue_size, 'loss': 0}
        lconfig_s1_s2 = {'bw': bw, 'delay': 1 + 'ms', 'max_queue_size': max_queue_size, 'loss': 0}
